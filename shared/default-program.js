...
export const DEFAULT_PROGRAM = {
  ...
  days: {
    ...
    B: [
      ...
      { id: 'b3', name: 'Разгибание ног (ограниченно)', target_sets: 2, target_reps: 15, no_progression: true, step: 2.5, machine: '«Leg Extension», валик спереди', technique: 'ТОЛЬКО верхняя треть амплитуды (~45° → выпрямление), лёгкий вес. Щелчки/боль → изометрия 10 сек', machine_type: 'leg_extension' },
      ...
      { id: 'b6', name: 'Жим на плечи (рычажный)', target_sets: 3, target_reps: 12, per_side: true, step: 2.5, warmup: true, machine: '«Shoulder Press», блины на каждую ручку; рукояти на уровне ушей на старте', technique: 'Спина к спинке, поясницу не отрывать. Записывай вес ОДНОЙ стороны — столько, сколько реально висит на каждой ручке', machine_type: 'shoulder_press' },
